/*!
 * PicPoints JavaScript Interactive Map Framework v@@version
 * https://yalogica.com/picpoints/
 * Date: @@date
 *
...
export { Shape, type ShapeConfig } from '@/shapes/shape';
export { Icon, type IconConfig } from '@/shapes/icon';
export { Location, type LocationConfig } from '@/shapes/location';